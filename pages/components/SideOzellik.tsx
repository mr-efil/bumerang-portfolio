...
const SideOzellik = ({
  ...
  return (
    <div
      ...
      }  w-full h-[30rem] lg:h-[45rem] lg:left-0 lg:right-0 lg:w-[30%] lg:justify-center flex flex-col rounded-xl my-4 bg-[rgb(232,232,232)] group`}
    >
      ...
      >
        ...
        <h3 className="font-light italic text-base lg:text-4xl group-hover:translate-x-3 duration-300">{children}</h3>
      </div>
    </div>
  );
};
